...
const socials = [
  {
    label: "GitHub",
    href: "https://github.com/abilashn2704",
    icon: (
  ...
  {
    label: "LinkedIn",
    href: "https://linkedin.com/in/abilashn",
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
      ...
      <div className="max-w-6xl mx-auto px-6">
        <div ref={ref} className="reveal max-w-xl">
          ...
          <p className="text-muted text-base leading-relaxed mb-8">
            Currently at Redefine Technologies. Available for freelance projects,
            collaborations, or full-time roles. Response within 24 hours.
          </p>

          <div className="flex flex-wrap gap-3 mb-10">
            <a
              href="mailto:abilashn2704@gmail.com"
              className="inline-flex items-center gap-2 bg-cobalt text-white text-sm px-6 py-3 rounded-md hover:bg-cobalt-dim active:scale-95 transition-all duration-200"
            >
              Send an email
